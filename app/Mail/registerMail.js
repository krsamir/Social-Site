                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td align="center"
                                                                                                                                            ...
                                                                                                                                            <a href=${FRONTENDLINK}/validate?token=${token}
                                                                                                                                                ...
                                                                                                                                                Now</a>
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%"
                                                                                                                                                                                                                                            style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
                                                                                                                                                                                                                                            <tbody>
                                                                                                                                                                                                                                                <tr>
                                                                                                                                                                                                                                                    <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;"
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        <div>
                                                                                                                                                                                                                                                            <div style="font-family: inherit; text-align: center">
                                                                                                                                                                                                                                                                <span style="font-size: 18px"><strong>Note:</strong> Link will expire at ${expiryTime}</span><span style="font-size: 18px">.</span>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                            <div>
                                                                                                                                                                                                                                                            </div>
                                                                                                                                                                                                                                                        </div>
